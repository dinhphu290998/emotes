...
class GunWheelPage extends StatefulWidget {
  @override
  _GunWheelPageState createState() => _GunWheelPageState();
}

class _GunWheelPageState extends State<GunWheelPage> {
  ...
  void initState() {
    ...
    while (rewards.length < 8) {
      rewards.add(guns[random.nextInt(guns.length)]);
    }

    _adController.ad = AdHelper.loadNativeLuckyGunAd(adController: _adController);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('GUNS SPIN WHEEL', style: TextStyle(
          color: Colors.white,
          fontSize: 22,
