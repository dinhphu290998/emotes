...
class DressWheelPage extends StatefulWidget {
  @override
  _DressWheelPageState createState() => _DressWheelPageState();
}

class _DressWheelPageState extends State<DressWheelPage> {
  ...
  void initState() {
    ...
    while (rewards.length < 8) {
      rewards.add(characters[random.nextInt(characters.length)]);
    }

    _adController.ad = AdHelper.loadNativeLuckyCharacterAd(adController: _adController);
